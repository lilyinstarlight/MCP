...
from mcp.common import error
from mcp.control import server, source
...
server_db = db.Database(config.database + '/servers.db', ['server', 'source', 'revision', 'port', 'autostart', 'users'])
