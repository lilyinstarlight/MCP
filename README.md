...
Place it in the `scripting` directory of the `mcp` package and reinstall. You can also (optionally) create your own `api.html` so that the documentation is available in the web interface.
